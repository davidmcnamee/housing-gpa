...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:RKeJXXWfg9N47RYfMm0+igkxBCTF4bzbneAxaqid0c4=",
        version = "v0.2.11",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:pFOI7cDz2wI+MwaoDqqrhFCXkwvpvkWpYQCXvQVAlfs=",
        version = "v0.7.10-0.20210411022516-8a92e977c10b",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:fzvwtC8MQzdGCcqVguZysvS44MbbzsCcqcH3WlzuDl8=",
        version = "v0.0.0-20210726113942-478c3f3c33cb",
    )
    go_repository(
        name = "io_entgo_ent",
        importpath = "entgo.io/ent",
        sum = "h1:pBl2eaSsIfQRT+8985JhMWekzeO+MwpX5Sc/hvQHCq8=",
        version = "v0.8.1-0.20210630104730-a19a89a141cf",
    )
    go_repository(
